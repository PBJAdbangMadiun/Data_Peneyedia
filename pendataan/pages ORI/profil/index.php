...
<?php 
    if (isset($_GET['edit'])) {
        ...
        if ($_GET['edit']=='berhasil'){
            echo"<div class='alert alert-success'>Profil pengguna telah berhasil diubah</div>";
        }else if ($_GET['edit']=='gagal'){
            echo"<div class='alert alert-danger'>Profil pengguna gagal diubah</div>";
        }    
    }
        ...
        <div class="box-body table-responsive no-padding">
            ...
            <style>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            <td colspan="2"> <img class="card-img-top" src="pages/pengguna/foto/<?php echo $data['foto'];?>" width="100px" alt="Card image"></td>
                        </tr>
                        <tr>
                            <td>Kode</td>
