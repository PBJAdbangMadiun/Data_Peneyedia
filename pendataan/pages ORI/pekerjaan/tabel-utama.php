    ...
    <tr>
        ...
        <?php
            ...
            if ($_POST['status']!='' and $_POST['kata_kunci']!=''){
                ...
                $query="select distinct p.*,n.nama as nama_provinsi from pekerjaan p left join provinsi n on n.id_prov=p.provinsi left join kelompok k on k.id_kelompok=p.kelompok left join anggota_pekerjaan a on a.id_pekerjaan=p.id_pekerjaan left join anggota t on t.id_anggota=a.id_anggota where p.status='".$_POST['status']."' order by p.id_pekerjaan desc limit $limit_start,$limit";
            } else if ($_POST['status']=='' and $_POST['kata_kunci']!=''){
                ...
                $query="select distinct p.*,n.nama as nama_provinsi from pekerjaan p left join provinsi n on n.id_prov=p.provinsi left join kelompok k on k.id_kelompok=p.kelompok left join anggota_pekerjaan a on a.id_pekerjaan=p.id_pekerjaan left join anggota t on t.id_anggota=a.id_anggota order by p.id_pekerjaan desc limit $limit_start,$limit";
            }
