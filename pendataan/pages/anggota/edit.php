...
<form action="pages/anggota/edit.php" method="post"  enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Tenaga Ahli/Teknis:</label>
        <select class="form-control" id="pendidikan" name="pendidikan">
            <option <?php if ($data['pendidikan']=='SLTA') echo "selected"; ?> value="SLTA">Petugas K3</option>
            <option <?php if ($data['pendidikan']=='D3') echo "selected"; ?> value="D3">Pelaksana Bangunan Gedung</option>
            <option <?php if ($data['pendidikan']=='S1') echo "selected"; ?> value="S1">Pelaksana Lapangan Pekerjaan Jalan</option>
            <option <?php if ($data['pendidikan']=='S2') echo "selected"; ?> value="S2">Team Leader</option>
