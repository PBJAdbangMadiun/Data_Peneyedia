...
<section class="content-header">
    <h1>
    Penyedia
    <xsmall>Menampilkan Daftar penyedia</xsmall>
    </h1>
    <ol class="breadcrumb">
...
<?php
    ...
    if (isset($_GET['tambah'])) {
        if ($_GET['tambah']=='berhasil'){
            echo"<div class='alert alert-success'><strong>Berhasil!</strong> Penyedia telah ditambahkan!</div>";
        }else if ($_GET['tambah']=='gagal'){
            echo"<div class='alert alert-danger'><strong>Gagal!</strong> Penyedia gagal ditambahkan!</div>";
        }    
    }
   ...
   //Validasi untuk menampilkan pesan pemberitahuan saat user mengubah kelompok
    if (isset($_GET['edit'])) {
      if ($_GET['edit']=='berhasil'){
          echo"<div class='alert alert-success'><strong>Berhasil!</strong> Penyedia telah diupdate!</div>";
      }else if ($_GET['edit']=='gagal'){
          echo"<div class='alert alert-danger'><strong>Gagal!</strong> Penyedia gagal diupdate!</div>";
      }    
    }
     //Validasi untuk menampilkan pesan pemberitahuan saat user hapus kelompok
    if (isset($_GET['hapus'])) {
      if ($_GET['hapus']=='berhasil'){
          echo"<div class='alert alert-success'><strong>Berhasil!</strong> Penyedia telah dihapus!</div>";
      }else if ($_GET['hapus']=='berhasil'){
          echo"<div class='alert alert-danger'><strong>Gagal!</strong> Penyedia gagal dihapus!</div>";
      }    
    }
?>
    ...
    $('#tambah_kelompok').on('click',function(){
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById("judul").innerHTML='Tambah Penyedia';
            }
        });
        // Membuka modal
        $('#modal').modal('show');
