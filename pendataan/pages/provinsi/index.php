...
<section class="content-header">
    <h1>
    PERANGKAT DAERAH
    <small>Menampilkan Daftar PERANGKAT DAERAH</small>
    </h1>
    <ol class="breadcrumb">
...
<?php
    ...
    if (isset($_GET['tambah'])) {
        if ($_GET['tambah']=='berhasil'){
            echo"<div class='alert alert-success'><strong>Berhasil!</strong> PERANGKAT DAERAH telah ditambahkan!</div>";
        }else if ($_GET['tambah']=='gagal'){
            echo"<div class='alert alert-danger'><strong>Gagal!</strong> PERANGKAT DAERAH gagal ditambahkan!</div>";
        }    
    }
