...
<div class="form-group">
    ...
    <input type="text" name="nama_bagian" value="<?php echo $data['nama_bagian'];?>" class="form-control" placeholder="Masukan nama paket">
</div>
...
<div class="form-group">
    <label>Pagu : </label>
    <input type="number" name="iuran_1" value="<?php echo $data['iuran1'];?>" id="iuran_1" class="form-control" placeholder="Masukan Pagu">
    <span id="nominal_iuran_1"> </span>
</div>

<div class="form-group">
    <label>HPS (Harga Perkiraan Sendiri) :</label>
    <input type="number" name="iuran_2" id="iuran_2" value="<?php echo $data['iuran2'];?>" class="form-control" placeholder="Masukan HPS">
...
<div class="form-group">
    ...
    <input type="number" name="iuran_3" id="iuran_3" value="<?php echo $data['iuran3'];?>" class="form-control" placeholder="Masukan Nilai Kontrak">
