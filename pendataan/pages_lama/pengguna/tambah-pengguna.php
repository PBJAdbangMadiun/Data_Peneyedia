        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($foto)){
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    $sql="insert into pengguna (kode_pengguna,nama_pengguna,email,foto,username,password,level,status) values
                        ('$kode_pengguna','$nama_pengguna','$email','$foto','$username','$password','$level','$status')";
                }
            }else {
                //Sql jika tidak menggunakan foto, maka akan memakai gambar pengguna_default.png
                $sql="insert into pengguna (kode_pengguna,nama_pengguna,email,foto,username,password,level,status) values
                ('$kode_pengguna','$nama_pengguna','$email','pengguna_default.png','$username','$password','$level','$status')";
            }
...
?>
<form action="pages/pengguna/tambah-pengguna.php" method="post" enctype="multipart/form-data">
