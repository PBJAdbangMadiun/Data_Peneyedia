...
<form action="pages/kelompok/tambah.php" method="post" >
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama_kelompok" class="form-control" placeholder="Masukan Nama Kelompok">
    </div>
    ...
    <div class="form-group">
        <label>Ketua:</label>
        <input type="text" name="ketua" class="form-control" placeholder="Masukan Ketua">
    </div>


    <div class="form-group">
        <label>Wakil Ketua:</label>
        <input type="text" name="wakil" class="form-control" placeholder="Masukan Wakil Ketua">
    </div>
